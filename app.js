      ...
      setTimeout(function(){
        try {
          ...
          try {
            ...
            var voice;
            var isMale=/male|david|mark|daniel|arthur|gordon|alex|aaron|fred|reed|rocko|alexander|yuri|ioan|toms|steffan|viktor|mikhail|nikola|petr|boris|vladimir|tolga|tom|tim|james|john|paul|mike|steve|peter|george|henry/i;
            if(ttsLang==='az'||ttsLang==='ru'){
              voice=vs.find(x=>x.lang.startsWith(pfx)&&isMale.test(x.name));
