...
const TOOLS = [
  { id:'image-to-pdf',       name:'Image to PDF',        icon:'material-symbols:description', cat:'pdf' },
  { id:'pdf-compressor',     name:'PDF Compressor',      icon:'material-symbols:compress', cat:'pdf' },
  { id:'merge-pdf',          name:'Merge PDF',           icon:'material-symbols:merge', cat:'pdf' },
  { id:'split-pdf',          name:'Split PDF',           icon:'material-symbols:content-copy', cat:'pdf' },
  { id:'create-pdf',         name:'Create PDF',          icon:'material-symbols:post-add', cat:'pdf' },
  { id:'pdf-to-jpg',         name:'PDF to JPG',          icon:'material-symbols:image', cat:'pdf' },
  { id:'unlock-pdf',         name:'Unlock PDF',          icon:'material-symbols:lock-open', cat:'pdf' },
  { id:'protect-pdf',        name:'Protect PDF',         icon:'material-symbols:lock', cat:'pdf' },
  { id:'extract-text',       name:'Extract Text',        icon:'material-symbols:text-snippet', cat:'pdf' },

  { id:'jpg-to-png',         name:'JPG to PNG',          icon:'material-symbols:transform', cat:'image' },
  { id:'png-to-jpg',         name:'PNG to JPG',          icon:'material-symbols:swap-horiz', cat:'image' },
  { id:'webp-converter',     name:'WebP Converter',      icon:'material-symbols:photo', cat:'image' },
  { id:'image-cropper',      name:'Image Cropper',       icon:'material-symbols:crop', cat:'image' },
  { id:'image-rotator',      name:'Image Rotator',       icon:'material-symbols:rotate-right', cat:'image' },
  { id:'image-flip',         name:'Image Flip',          icon:'material-symbols:flip', cat:'image' },
  { id:'brightness-adjuster',name:'Brightness',          icon:'material-symbols:brightness-5', cat:'image' },
  { id:'contrast-adjuster',  name:'Contrast',            icon:'material-symbols:contrast', cat:'image' },
  { id:'grayscale-filter',   name:'Grayscale',           icon:'material-symbols:invert-colors', cat:'image' },
  { id:'remove-bg',          name:'Remove Background',   icon:'material-symbols:wand-stars', cat:'image' },
  { id:'image-compressor',   name:'Image Compressor',    icon:'material-symbols:compress', cat:'image' },
  { id:'image-resize',       name:'Image Resize',        icon:'material-symbols:aspect-ratio', cat:'image' },
  { id:'add-border',         name:'Add Border',          icon:'material-symbols:border-style', cat:'image' },
  { id:'round-image',        name:'Make Round',          icon:'material-symbols:circle', cat:'image' },
  { id:'image-splitter',     name:'Image Splitter',      icon:'material-symbols:dashboard', cat:'image' },
  { id:'pixelate',           name:'Pixelate',            icon:'material-symbols:grain', cat:'image' },
  { id:'combine-images',     name:'Combine Images',      icon:'material-symbols:layers', cat:'image' },
  { id:'add-text',           name:'Add Text',            icon:'material-symbols:text-fields', cat:'image' },
  { id:'blur-bg',            name:'Blur Background',     icon:'material-symbols:blur-on', cat:'image' },
  { id:'profile-photo',      name:'Profile Photo',       icon:'material-symbols:face', cat:'image' },

  { id:'word-counter',       name:'Word Counter',        icon:'material-symbols:123', cat:'dev' },
  { id:'password-generator', name:'Password Generator',  icon:'material-symbols:vpn-key', cat:'dev' },
  { id:'qr-code-generator',  name:'QR Code Generator',   icon:'material-symbols:qr-code', cat:'dev' },
  { id:'json-formatter',     name:'JSON Formatter',      icon:'material-symbols:data-object', cat:'dev' },
  { id:'url-encoder',        name:'URL Encoder',         icon:'material-symbols:link', cat:'dev' },
  { id:'sha256-generator',   name:'SHA256 Generator',    icon:'material-symbols:shield', cat:'dev' },
  { id:'text-case-converter',name:'Text Case Converter', icon:'material-symbols:text-fields', cat:'dev' },
  { id:'base64-encode',      name:'Base64 Encode/Decode',icon:'material-symbols:code', cat:'dev' },
  { id:'md5-generator',      name:'MD5 Generator',       icon:'material-symbols:fingerprint', cat:'dev' },
  { id:'uuid-generator',     name:'UUID Generator',      icon:'material-symbols:badge', cat:'dev' },
  { id:'color-picker',       name:'Color Picker',        icon:'material-symbols:colorize', cat:'dev' },
  { id:'color-converter',    name:'Color Converter',     icon:'material-symbols:palette', cat:'dev' },
  { id:'lorem-ipsum',        name:'Lorem Ipsum',         icon:'material-symbols:article', cat:'dev' },
  { id:'text-cleaner',       name:'Text Cleaner',        icon:'material-symbols:cleaning-services', cat:'dev' },
  { id:'html-viewer',        name:'HTML Viewer',         icon:'material-symbols:web', cat:'dev' },
  { id:'epoch-converter',    name:'Epoch Converter',     icon:'material-symbols:schedule', cat:'dev' },

  { id:'csv-json',           name:'CSV ↔ JSON',          icon:'material-symbols:data-table', cat:'converter' },
  { id:'xml-json',           name:'XML ↔ JSON',          icon:'material-symbols:data-array', cat:'converter' },
  { id:'split-csv',          name:'Split CSV',           icon:'material-symbols:content-cut', cat:'converter' },
  { id:'create-zip',         name:'Create ZIP',          icon:'material-symbols:folder-zip', cat:'converter' },
  { id:'ai-image-generator', name:'AI Image Generator',  icon:'material-symbols:auto-awesome-mosaic', cat:'ai' },
  { id:'ai-prompt-enhancer', name:'AI Prompt Enhancer',  icon:'material-symbols:rocket-launch', cat:'ai' },
  { id:'ai-text-summarizer', name:'AI Text Summarizer',  icon:'material-symbols:summarize', cat:'ai' },
  { id:'ai-grammar-rewrite', name:'AI Grammar & Rewrite',icon:'material-symbols:spellcheck', cat:'ai' },
  { id:'ai-cv-generator',    name:'AI CV Generator',     icon:'material-symbols:assignment', cat:'ai' },
  { id:'ai-resume-analyzer', name:'AI Resume Analyzer',  icon:'material-symbols:assignment-ind', cat:'ai' },
  { id:'ai-cover-letter',    name:'AI Cover Letter',     icon:'material-symbols:school', cat:'ai' },
  { id:'photo-enhancer',     name:'Photo Enhancer',      icon:'material-symbols:auto-awesome-motion', cat:'ai' },
  { id:'ai-ocr',             name:'AI Image to Text (OCR)',icon:'material-symbols:visibility', cat:'ai' },
  { id:'object-remover',     name:'Object Remover',      icon:'material-symbols:ink-eraser', cat:'ai' },
  { id:'image-cleanup',      name:'Image Cleanup Tool',  icon:'material-symbols:cleaning-services', cat:'ai' },
];
...
function filterTools(cat){
  ...
  TOOLS.forEach(function(t){
    ...
    card.innerHTML =
      '<div class="tool-icon"><span class="iconify" data-icon="' + t.icon + '" data-width="30" data-height="30"></span></div>' +
